# Simple replacement of MapToDto method
$filePath = "backend/InsuranceAPI/Services/OfferService.cs"
$content = Get-Content $filePath -Raw

# Replace the entire MapToDto method with the correct flat property approach
$oldMethod = '        // Offer entity''sini OfferDto''ya dönüştür
...
Write-Host "Successfully replaced MapToDto method with flat properties"
